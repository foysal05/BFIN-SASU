        ...
        <div class="col-md-12">
            <div class="error-template">
                <h1>
                    Oops!</h1>
                <h2>
                    Your account has been <span style="color: red">deactivated</span> </h2>
                <div class="error-details">
                   Please contact with administrator.
                </div>
                <div class="error-actions">
                   <!--  <a href="index" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>Take Me Home </a> -->
                        <a href="logout" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-off"></span> Logout </a>
